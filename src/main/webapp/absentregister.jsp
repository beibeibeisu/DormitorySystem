...
<div class="container-fluid">
    <form method="post" action="${pageContext.servletContext.contextPath}/absent/save" class="form-horizontal" style="margin-top: 0px" role="form"
...
<script>
    $(function(){
        $('#building').change(function(){
            var id = $(this).val();
            $.ajax({
                url:"${pageContext.servletContext.contextPath}/dormitory/findByBuildingId?buildingId="+id,
                type:"post",
        ...
        $('#dormitory').change(function(){
            var id = $(this).val();
            $.ajax({
                url:"${pageContext.servletContext.contextPath}/student/findByDormitoryId?dormitoryId="+id,
                type:"post",
                contentType:"application/json;charset=UTF-8",
                dataType:"text",
                success:function (data) {
