        ...
        <div class="col-sm-10">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" class="form-inline" action="${pageContext.servletContext.contextPath}/student/search" method="post">
            ...
            <div class="table-responsive">
                ...
                <!-- add框示例（Modal） -->
                <form method="post" action="${pageContext.servletContext.contextPath}/student/save" class="form-horizontal" style="margin-top: 0px" role="form"
                ...
                <!-- update框示例（Modal） -->
                <form method="post" action="${pageContext.servletContext.contextPath}/student/update" class="form-horizontal" style="margin-top: 0px" role="form"
                      id="form_data" style="margin: 20px;">
                ...
                <!-- 删除模态框示例（Modal） -->
                <form method="post" action="${pageContext.servletContext.contextPath}/student/delete"
            ...
            <div class="footer">
                <p class="text-center">
                    <c:if test="${pageInfo.isFirstPage==false}">
                        <a href="${pageContext.servletContext.contextPath}/student/list">首页</a>&nbsp;&nbsp;
                    </c:if>
                    <c:forEach items="${pageInfo.navigatepageNums}" var="index">
                        <a href="${pageContext.servletContext.contextPath}/student/page/${index}">${index}</a>&nbsp;&nbsp;
                    </c:forEach>
                    <c:if test="${pageInfo.isLastPage==false}">
                        <a href="${pageContext.servletContext.contextPath}/student/page/${pageInfo.pages}">末页</a>
                    </c:if>
                </p>
            </div>
        </div>
