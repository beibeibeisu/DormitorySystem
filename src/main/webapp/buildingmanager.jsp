        ...
        <div class="col-sm-10">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" class="form-inline" action="${pageContext.servletContext.contextPath}/building/search" method="post">
            ...
            <div class="table-responsive">
                ...
                <!-- add框示例（Modal） -->
                <form method="post" action="${pageContext.servletContext.contextPath}/building/save" class="form-horizontal" style="margin-top: 0px" role="form"
                ...
                <!-- update框示例（Modal） -->
                <form method="post" action="${pageContext.servletContext.contextPath}/building/update" class="form-horizontal" style="margin-top: 0px" role="form"
                      id="form_data" style="margin: 20px;">
                ...
                <!-- 删除模态框示例（Modal） -->
                <form method="post" action="${pageContext.servletContext.contextPath}/building/delete"
