        ...
        <div class="col-sm-10">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" class="form-inline" action="${pageContext.servletContext.contextPath}/moveout/search" method="post">
            ...
            <div class="table-responsive">
                ...
                <!-- 删除模态框示例（Modal） -->
                <form method="post" action="${pageContext.servletContext.contextPath}/moveout/register"
